...
import { createDogs, getAllTemperament, updateDog } from '../action/action';
...
export const DogUpdate = () => {
    ...
    const dogUpdate=useSelector(state=>state.dogCreate)
    console.log(dogUpdate[0].name)
    const [form, setForm] = useState({
      name:dogUpdate.name ,
      heightMin: dogUpdate.heightMin,
      heightMax: dogUpdate.heightMax,
      weightMin: dogUpdate.weightMin,
      weightMax: dogUpdate.weightMax,
      life_span_Since:dogUpdate.life_span_Since,
      life_span_Until: dogUpdate.life_span_Until,
      temperaments:[...dogUpdate.temperaments]
    });
